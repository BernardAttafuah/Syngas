...
st.write(
    '''
    #### Summary of Parameters Selected
    '''
)
st.sidebar.success('Select Parameters')

FAo = st.sidebar.slider('Methane Flow Rate (mol/sec)',1,2000,1000)
FBo = st.sidebar.slider('Steam Flow Rate (mol/sec)',1,3000,1500)
To = st.sidebar.slider('Initial Temperature (K)',1000,3000,2800)
Po = st.sidebar.slider('Initial Pressure (bar)',10,50,30)
#min = st.sidebar.slider('Lower Integral Limit (kg)',0,4,0)
#max = st.sidebar.slider('Upper Integral Limit (kg)',3,10,7)
